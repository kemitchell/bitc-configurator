...
module.exports = function(grunt) {
	...
	grunt.registerTask('bitc:switchnetwork', 'switch to Intranet', function() {
		...
		prompt.get([
			{
				name: 'switchnetwork',
				description: 'Please switch the network connection to the Intranet and press any key to continue. DO NOT CONTINUE UNLESS THE SERVER IS SET UP AND TURNED ON!',
				type: 'string',
				required: false,
			}
		], function(err, result) {
			...
			grunt.log.writeln('WARNING: TODO: Actually perform network switch.'.yellow);
