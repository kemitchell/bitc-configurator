...
module.exports = function(grunt) {
	...
	grunt.registerTask('bitc:setup:log:god:start', 'logging', function() {
		grunt.log.writeln('Updating god settings...'.grey);
	});
	grunt.registerTask('bitc:setup:log:god:end', 'logging', function() {
	...
	grunt.registerTask('bitc:setup:log:bitc:start', 'logging', function() {
		grunt.log.writeln('Setting BITC-specific configuration...'.grey);
	});
	grunt.registerTask('bitc:setup:log:bitc:end', 'logging', function() {
